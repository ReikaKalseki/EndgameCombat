...
LIGHTNING_TURRET_RECHARGE_TECH_COUNT = 5
LIGHTNING_TURRET_RECHARGE_TIME_REDUCTION_PER_TECH = 60*1 -- therefore down to 5s at level 5
LIGHTNING_TURRET_SPLASH_FACTORS = {0.025, 0.075, 0.15, 0.25, 0.5, 1}

SHIELD_REACTIVATE_FRACTION = {0.4, 0.38, 0.35, 0.32, 0.29, 0.25, 0.2, 0.15, 0.1, 0.05, 0.02}
...
SHOCKWAVE_RANGE_BOOSTS = {2, 3, 5} --starts at 10, so totals 12, 15, 20
SHOCKWAVE_RANGE_BOOST_SUMS = {}
...
sum = 0
for i = 1,#SHOCKWAVE_RANGE_BOOSTS do
	sum = sum+SHOCKWAVE_RANGE_BOOSTS[i]
	SHOCKWAVE_RANGE_BOOST_SUMS[#SHOCKWAVE_RANGE_BOOST_SUMS+1] = sum
end
